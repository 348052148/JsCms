...
<meta name="description" content="${type.about}" />
...
<div class="wpm list">
  ...
  <div class="tab1 tab1b main">
    ...
    <div class="content">
       ...
       <li><span >${content.addtime }</span><a href="index.php?a=content&aid=${content.id}&id=${type.id}" style="" target="_blank">${content.title }</a></li>
       </c:forEach>
       </ul>
       <ul class="c pages"></ul>
    </div>
