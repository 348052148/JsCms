...
<div class="wpm list">
  ...
  <div class="tab1 tab1b main">
    ...
    <div class="content">
       ...
       <dl><dt><a href="index.php?a=content&aid=${content.id}&id=${type.id}" style="" target="_blank"><img src="${content.litpic }" /></a></dt><dd><a href="index.php?a=content&aid=${content.id}&id=${type.id}" style="" target="_blank">${content.title }</a></dd></dl>
       </c:forEach>
       </div>
       <ul class="c pages"></ul>
    </div>
