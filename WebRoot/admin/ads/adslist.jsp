	...
	-->
		<div class="" style="width:600px;">
			<ul class="nav nav-pills nav-justified">
			  ...
			  <li role="presentation" class="active"><a href="<%=JSUtils.buildReqPath(request, "ads", "ads") %>">广告列表</a></li>
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-heading">栏目列表</div>
				  ...
				  <table class="table table-hover">
					...
					<tbody>
					<c:forEach begin="0" items="${requestScope.adsList }" var="ads">
						<tr>
							...
							<td>${ads.name }</td>
							<td>宽：${ads.adsw } 高：${ads.adsh }</td>
							<td><a href="<%=JSUtils.buildReqPath(request, "ads", "editAds") %>&id=${ads.id}">编辑</a>&nbsp;&nbsp;&nbsp;<a href="<%=JSUtils.buildReqPath(request, "ads", "deleteAds") %>&id=${ads.id}">删除</a></td>
						  </tr>
					</c:forEach>
